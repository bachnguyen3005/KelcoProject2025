...
class QtWaitingSpinner(QWidget):
    def __init__(
        ...
        self._roundness = 186.43
        self._minimumTrailOpacity = 19.75
        self._trailFadePercentage = 28.67
        self._revolutionsPerSecond = 1.32
        self._numberOfLines = 147
        self._lineLength = 10
        self._lineWidth = 6
        self._innerRadius = 23
        ...
        # Set up the specific modality
        if modality == Qt.WA_TransparentForMouseEvents:
    ...
    def paintEvent(self, event):
        ...
        for i in range(self._numberOfLines):
            ...
            rect = QRect(0, -self._lineWidth / 2, self._lineLength, self._lineWidth)
