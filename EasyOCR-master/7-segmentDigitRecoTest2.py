...
height = dimension[0]
width = dimension [1]
cropped_image = image[52:120, 96:275]
...
#Crop digit number 1
digit1 = gray_cropped_image[3:67, 28:60 ]   #[height, width]
cv2.imwrite('digit1.jpg', digit1)

gap = 8
width = 34
#Crop digit number 2
digit2 = gray_cropped_image[3:67, 60+gap:60+gap+width]   #[height, width]
cv2.imwrite('digit2.jpg', digit2)

#Crop digit number 3
digit3 = gray_cropped_image[3:67, 60+gap*2+width+5:60+gap*2+width*2+2]   #[height, width]
...
# cv2.rectangle(digit1, (0, 0), (roiW, dH), (255,0,0), 1)
cv2.rectangle(thresh3, (0, 0), (dW3, roiH3 // 2), (255,0,0), 1)
...
cv2.imshow('image1Cropped', digit1)
cv2.imshow('image2Cropped', digit2)
cv2.imshow('image3Cropped', digit3)
